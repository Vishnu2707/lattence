...
def test_chain_returns_presentation_for_vulnerable_agent(client: TestClient) -> None:
    response = client.get("/v1/chain", params={"path": "examples/vulnerable-agent"})
...
def test_chain_returns_404_for_missing_path(client: TestClient) -> None:
