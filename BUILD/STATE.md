...
- Last completed: T-078, create flagship crypto architecture and migration workflow diagrams
- Next task: T-079, author the complete v0.4 cryptography documentation section
- Blockers: none
...
- v0.4 tasks: 14 done, 3 todo (T-079 through T-081)
