...
- Last completed: T-097, implement interactive attack-graph path selection and
  cross-layer evidence drill-down
- Next task: T-098, wire TUI and dashboard data export to the shared workflow
- Blockers: none
...
- Remote: `origin/dev` up to date through T-097 after the task push
...
- v0.5 tasks: 9 done, 6 todo (T-098 through T-103)
