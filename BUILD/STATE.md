...
- Last completed: T-122, document the plugin SDK for third-party
  SecurityProvider adapters
- Next task: T-123, document API authentication and record RBAC and SSO as
  deferred to Phase 5
- Blockers: none.
...
- v1.0 phase 2 tasks: 7 done, 5 todo
