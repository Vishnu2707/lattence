...
- Last completed: T-118, wire POST /v1/attack to the existing attack workflow
- Next task: T-119, wire GET /v1/chain to the existing graph chain workflow
- Blockers: none.
...
- v1.0 phase 2 tasks: 3 done, 9 todo
